...
私たちが行ったワークショップでは、参加者の思考が引っ張られないように「ワークショップ成果物の模範解答は用意しない」という方針を決めていました。当日集まった参加者たちが、その日に議論した内容でチームならではの成果物を創ることを期待していることが模範解答を用意しない理由です。参加者がこちらの予定通りの成果物を作ってくれることはない（モデレータチームが想定しきれない）ため、モデレータは柔軟に対応できるような心構えをしておく必要がありました。しかし、特定の答えを用意しないことが不安になるモデレータもいました。

参加者全員に満足していただくため、モデレータ全員の不安は取り除き自信をもって当日に挑むことは必要なこととなります。そのため、モデレータの最低限の仕事として、前述の「持ち帰ってもらいたい物を共有しよう」で挙げた「参加者に持って帰ってもらいたいモノ」を持ち帰ってもらう、ということを定めました。また、参加者に大きく依存するワークショップにおいて、「どのようにして持ち帰ってもらうか」も議論して共有することにしました。例えば、モデレータチームは同じワークを何回もやっているため、毎回「同じように考えた」ことは共有できています。そのため、参加者が「同じように考えた」ときに、新しい観点を与えることによって「参加者に持ち帰ってもらいたいモノ」に気づいてもらえるだろう、と仮定を用意しておきました。アクションが決まることによって、モデレータが最低限実行しなければならないことが明確にしたことが、モデレータの不安を緩和する働きをしました。
